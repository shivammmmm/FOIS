      ...
      >
        ...
        >
          <Route element={<Layout />}>
            ...
            <Route path="/admin/matching" element={<Navigate to="/admin/fois-reports" replace />} />
            <Route path="/admin/odr-matured-comparison" element={<Navigate to="/admin/fois-reports" replace />} />
        ...
        >
          <Route element={<Layout />}>
            <Route path="/user/freight-status" element={<Navigate to="/fois-reports" replace />} />
            <Route path="/freight-status" element={<Navigate to="/fois-reports" replace />} />
